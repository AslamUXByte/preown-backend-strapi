...
export interface ApiGadgetInCalicutGadgetInCalicut
  extends Struct.CollectionTypeSchema {
  collectionName: 'gadget_in_calicuts';
  info: {
    displayName: 'Gadget-in-calicut';
    pluralName: 'gadget-in-calicuts';
    singularName: 'gadget-in-calicut';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::gadget-in-calicut.gadget-in-calicut'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiGadgetInKochiGadgetInKochi
  extends Struct.CollectionTypeSchema {
  collectionName: 'gadget_in_kochis';
  info: {
    displayName: 'Gadget-in-kochi';
    pluralName: 'gadget-in-kochis';
    singularName: 'gadget-in-kochi';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::gadget-in-kochi.gadget-in-kochi'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiNewProductNewProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Condition: Schema.Attribute.Enumeration<
      ['Brand New', 'Just Active', 'Preowned']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    ProductCategory: Schema.Attribute.Enumeration<
      ['Smart Phone', 'Tablet', 'Laptop', 'Smart Watch', 'TWS']
    >;
    ...
    ScreenSizewithRefreshRate: Schema.Attribute.String;
    SerialNumber: Schema.Attribute.String;
    shop_location: Schema.Attribute.Relation<
      'oneToOne',
      'api::shop-location.shop-location'
    >;
    ShopWarrentyInDays: Schema.Attribute.Integer;
    Sim1: Schema.Attribute.Enumeration<['eSIM', 'Physical SIM']>;
    Sim2: Schema.Attribute.Enumeration<['eSIM', 'Physical SIM']>;
    site_user_carts: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProductReviewProductReview
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    new_product: Schema.Attribute.Relation<
      'manyToOne',
      'api::new-product.new-product'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSeoSeo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ogImages: Schema.Attribute.Media<'images', true>;
    ogTitle: Schema.Attribute.String;
    ogType: Schema.Attribute.Enumeration<
      ['website', 'article', 'profile', 'video', 'music']
    > &
      Schema.Attribute.DefaultTo<'website'>;
    ogUrl: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    robotsMeta: Schema.Attribute.String;
    slug: Schema.Attribute.UID;
...
export interface ApiShopLocationShopLocation
  extends Struct.CollectionTypeSchema {
  collectionName: 'shop_locations';
  info: {
    displayName: 'Shop Location';
    pluralName: 'shop-locations';
    singularName: 'shop-location';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiSiteUserCartSiteUserCart
  extends Struct.CollectionTypeSchema {
  collectionName: 'site_user_carts';
  info: {
    displayName: 'Site User Cart';
    pluralName: 'site-user-carts';
    singularName: 'site-user-cart';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiTestamonialTestamonial extends Struct.CollectionTypeSchema {
  collectionName: 'testamonials';
  info: {
    displayName: 'Testamonial';
    pluralName: 'testamonials';
    singularName: 'testamonial';
  };
  options: {
    draftAndPublish: true;
  };
